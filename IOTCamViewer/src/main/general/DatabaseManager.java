...
//		db.update(TABLE_DEVICE_CHANNEL, values, "dev_uid_and_channel = '" + dev_uid_and_channel + "'", null);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate (SQLiteDatabase db) {
            ...
            } else if (mcontext.getPackageName().equals(myPackageInfo.KALAY_CAR) || mcontext.getPackageName().equals(myPackageInfo.CAMBOSS)|| mcontext.getPackageName().equals(myPackageInfo.WIMCAM)) {
